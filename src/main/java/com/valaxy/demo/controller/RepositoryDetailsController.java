...
public class RepositoryDetailsController {
	...
	public String getRepos() throws IOException {
		GitHub github = new GitHubBuilder().withPassword("gouravpatel0897@gmail.com", "XXXXXXXX").build();
		GHRepositorySearchBuilder builder = github.searchRepositories();
		return "Hi Everyone👋 I'm Gourav Patel, A passionate DevOps Engineer From India";
	}
